...
use mantaray_gui::theme::Theme;
use mantaray_gui::view::{MarkMode, ViewEvent, ViewHeader, ViewInput, draw};
use mantaray_gui::viewmodel::DisplayState;
        ...
        let _ = self.ctx.run_ui(input, |ui| {
            reported = draw(
                ...
                ViewInput {
                    ...
                    style: mantaray_gui::theme::SchemeStyle::default(),
                    selection: None,
                    peak_info: None,
                    peak_font: 11.0,
                    header: ViewHeader {
