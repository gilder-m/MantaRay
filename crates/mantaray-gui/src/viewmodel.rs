...
pub struct DisplayState {
    ...
    /// Whether found peaks are named on the plot (Display/Peak Labels).
    ///
    /// The carets stay either way: they say where a peak was found, which is
    /// not the same claim as what it is. A spectrum with sixty regions marked
    /// carries sixty labels, and past a certain density they stop naming peaks
    /// and start hiding the data behind them.
