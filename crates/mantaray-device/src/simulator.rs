...
use mantaray_core::{AcquisitionMode, EnergyCalibration, ShapeCalibration, Spectrum};
use mantaray_formats::ListModeFile;
...
impl SimulatedMcbBuilder {
    ...
    pub fn build(self) -> SimulatedMcb {
        ...
        let mut identity = McbIdentity {
            ...
            firmware: concat!("mantaray simulator ", env!("CARGO_PKG_VERSION")).to_string(),
...
impl SimulatedMcb {
    ...
    fn sample_channel(&mut self, energy: f64) -> Option<usize> {
        ...
        let sigma = (fwhm_channels / mantaray_core::FWHM_PER_SIGMA).max(0.35);
