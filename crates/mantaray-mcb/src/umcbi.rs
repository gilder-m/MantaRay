...
//! executable rather than inside mantaray: a 64-bit process cannot load it. The
...
macro_rules! signatures {
    ($($field:ident: fn($($arg:ty),*) -> $ret:ty, $symbol:literal;)*) => {
        /// The subset of UMCBI mantaray uses, resolved from the DLL.
