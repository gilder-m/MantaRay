...
use mantaray_core::{EnergyCalibration, Roi, RoiSet, Spectrum};
use mantaray_formats::{AsciiOptions, FormatError, ascii, native, roi};
...
fn native_json_keeps_the_whole_model() {
    ...
    assert!(text.contains("\"mantaray\""), "the file is self describing");
}
